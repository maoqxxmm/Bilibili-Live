...
<script>
    ...
    export default {
        ...
        mounted() {
            var _this = this;
            this.$http.get('http://hz.aliyun.xeroe.net:81/json.php?q=/area/home?area=sing-dance&order=online&cover=1').then((response) => {
